...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 72.21;
        FollowerConstants.yMovement = 45.96;

        FollowerConstants.forwardZeroPowerAcceleration = -50.83;
        FollowerConstants.lateralZeroPowerAcceleration = -79.43;
